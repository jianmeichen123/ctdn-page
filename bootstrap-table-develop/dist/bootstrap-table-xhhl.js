...
! function ($) {
    ...
    BootstrapTable.prototype.initCustomToolbar = function () {
    	...
    	this.$toolbar.on("click","[action='querySearch']",function(){
    		that.trigger("querySearch");
    	});
	}
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        if (!html.length) {
            html.push('<tr class="no-records-found">',
                sprintf('<td colspan="%s" style="text-align:center !important;color:#bbb;border:0;line-height:32px !important" class="noinfo no_info01"><label class="no_info_icon_xhhl">%s</label></td>',
    ...
    BootstrapTable.prototype.getCustomToolbar = function () {
    	...
    	var query = {};
        //修改
        toolbar.find(".no_none").each(function(){
            var input = $(this);
