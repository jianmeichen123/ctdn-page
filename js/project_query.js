             ...
             for(i in jsonObjArr){
                ...
                for(j in i){
                    ...
                    if(json.invstor!=null&&j<3){
                        ...
                        if(json.id){
                            if(json.type=='invst'){
                                investTitle+='<center><span class="list_table_td"><a target="_blank" href="/jg_particulars.html?orgId='+json.id+'" title="'+json.invstor+'" class="invstorName">'+con+'</a></span></center>';
                            }
                            if(json.type=='com'){
                                investTitle+='<center><span class="list_table_td"><a target="_blank" href="/project_qy.html?code='+json.code+'"  title="'+json.invstor+'" class="invstorName">'+con+'</a></span></center>';
                            }
                            if(json.type!='invst'&&json.type!='com'){
                                investTitle+='<center><span class="list_table_td invstorName" title="'+json.invstor+'">'+con+'</span></center>';
                            }
                        }else{
                            investTitle+='<center><span class="list_table_td invstorName" title="'+json.invstor+'">'+con+'</span></center>';
                        }
